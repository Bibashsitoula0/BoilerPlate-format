...
import { updateDefaultNavigation } from 'app/mock-api/common/navigation/data';
import { DataService } from 'app/shared/data.service';
@Injectable()
export class AuthService {
    public _authenticated: boolean = false;
    // basepath = environment.apiUrl;
    // loginpath = this.basepath + 'Account/';
    ...
    signIn(username: string, password: string) {
        ...
        return this.accountService.login(username, password).pipe(
            catchError((response) => {
